...
import AjoutRL from '../components/responsable-livraison/ajout-responsable-livraison'
import ModifierRL from '../components/responsable-livraison/modifier-responsable-livraison'
...
export default function ListRL() {
                ...
                <Col xs={12}>
                    ...
                    <TableContainer component={Paper}>
                        <Table className={classes.table} aria-label="customized table">
                            ...
                            <TableBody>
                                {list && list.filter((val) => (val.type !== "RP")).filter((val) => {
                                    if (searchTerm == "") {
                                        return val
                                    ...
                                    <StyledTableRow key={row.name}>
                                        ...
                                        <StyledTableCell align="right">
                                            ...
                                            <ModifierRL id={rowId} name={rowName} email={rowEmail} show={modalOpen}
